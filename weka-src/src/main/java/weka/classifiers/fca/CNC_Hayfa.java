...
{	
    ...
    // Une structure contenant les r�gles uniques
    ...
    //public static final int coeff1 = 1;	// Default: Vote pond�r�
    ...
    public static final int Vote_Pond = 1;	// Default: Vote pond�r�
	...
	public void setVote_Methods(SelectedTag agregation) {
		...
		/**
	 * Un filtre permettant de transformer les donn�es num�riques en donn�es nominales
	 */
